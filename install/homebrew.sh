...
brew install --cask 1password 1password-cli lastpass lastpass-cli outline-manager mullvadvpn

brew install licecap ffmpeg gifsicle

brew install browserstacklocal ngrok
